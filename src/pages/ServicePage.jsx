            ...
            <div className="h-[100h] flex flex-col justify-center gap-10 pb-16 bg-[#DFF2EB]">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex text-center p-2 items-center justify-evenly gap-5">
                        ...
                        <Link to="/WebDevPage">
                            <div className="relative w-[25vw] h-[35vh] bg-[#ecf9f4] hover:text-white text-center flex flex-col justify-center px-4 gap-2 mb-5 border-2 rounded-lg border-black/35 hover:shadow-[18px_18px_15px_-7px_#636363] hover:border-[#636363] transition-transform duration-300 hover:scale-105 overflow-hidden group">
                                {/* Background Video */}
                                <video
                                    className="absolute top-0 left-0 w-full h-full opacity-0 object-cover -z-10 transition-opacity duration-300 group-hover:opacity-100"
                                    autoPlay
                        ...
                        <Link to="/WebDesigningPage" aria-label="Navigate to Web Designing Page">
                            <div className="relative w-[25vw] h-[35vh] bg-[#ecf9f4] hover:text-white border-2 rounded-lg border-black/35 text-center flex flex-col justify-center px-4 gap-2 mb-5 hover:shadow-[18px_18px_15px_-7px_#636363] hover:border-[#636363] overflow-hidden group transition-transform duration-300 hover:scale-105">
                                {/* Background Video */}
                                <video
                                    className="absolute top-0 left-0 w-full h-full opacity-0 object-cover -z-10 transition-opacity duration-300 group-hover:opacity-100"
                                    autoPlay
