            ...
            <div className="bg-[#DFF2EB]">
                ...
                <div className="pb-20 bg-[#DFF2EB]">
                    <div className="pt-16 sm:pt-32 pb-10 sm:pb-20 px-4 sm:px-20 lg:px-40 flex flex-col gap-4 sm:gap-10">
                        <h1 className="text-3xl sm:text-5xl font-bold font-fontProtest">Our Mission</h1>
                        <p className="text-lg sm:text-xl text-gray-500 font-thin font-fontDyan">
