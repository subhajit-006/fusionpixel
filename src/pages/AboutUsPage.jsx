    ...
    return (
        <>
            ...
            <div className="bg-[#DFF2EB]">
                <Navbar />
                <div className="h-[45vh] flex justify-center items-center flex-col gap-2 bg-[#DFF2EB]">
                    <h1 className="text-6xl font-bold font-fontProtest">About FusionPixellabs</h1>
                    <p className="text-xl text-gray-500 font-fontDyan font-thin">Transforming ideas into visual masterpieces since 2024</p>
                </div>

                <div className="pb-20 bg-[#DFF2EB]">
                    <div className="pt-32 pb-20 px-40 flex flex-col gap-10">
                        <h1 className="text-5xl font-bold font-fontProtest">Our Mission</h1>
                        <p className="text-xl text-gray-500 font-thin font-fontDyan">
