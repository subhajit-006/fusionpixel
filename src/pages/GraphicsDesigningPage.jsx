        ...
        <>
            ...
            <Navbar />
                <div className="flex justify-center items-center flex-col gap-3 h-96">
                    ...
                    <p className="text-gray-700 text-xl font-light font-fontDyan">Bringing your ideas to life with stunning visuals and creative designs</p>
                    <a
                        href="#contact"
                ...
                <div id="contact" className="flex justify-between items-center p-20">
                    ...
                    <div className="flex flex-col gap-2 w-[40vw]">
                        ...
                        <p className="text-gray-700 text-xl font-thin font-fontDyan">Let's create stunning graphics that capture your brand's essence and resonate with your audience</p>
                    </div>
                </div>
