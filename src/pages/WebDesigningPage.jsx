        ...
        <>
            ...
            <div className="bg-[#0E3332]">
                ...
                <div className="flex justify-center items-center flex-col gap-3 h-auto px-5 py-10 md:h-96">
                    <h1 className="font-bold text-4xl md:text-6xl font-fontProtest text-center">Web Designing Services</h1>
                    <p className="text-gray-700 text-lg md:text-xl font-thin font-fontDyan text-center">
                ...
                <div>
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center p-5 md:p-20 gap-10">
                        ...
                        <div className="flex flex-col gap-5 items-center">
                            ...
                            <a href="https://intern-ship-nine.vercel.app/" target="_blank" className="w-[75px] text-xl font-fontDyan font-thin bg-black text-white border-2 border-black px-3 py-2 rounded-full transition-transform duration-300 transform hover:scale-110">
                                Visit!
                            </a>
                        </div>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center p-5 md:p-20 h-auto md:h-[75vh]">
                    <div className="flex flex-col gap-2 w-full md:w-1/2">
                        ...
                        <ul className="flex flex-col gap-3 text-lg text-gray-700 font-fontDyan font-light">
                ...
                <div id="contact" className="flex flex-col md:flex-row justify-between items-center p-5 md:p-20">
                    ...
                    <div className="flex flex-col gap-2 w-full md:w-[40vw]">
                        ...
                        <p className="text-gray-700 text-lg md:text-xl font-fontDyan font-thin">
