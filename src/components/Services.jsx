...
function Services() {
    return (
        <div className="flex justify-center pt-20">
            <div className="p-5 bg-gray-100 h-[80vh] rounded-2xl w-[95vw] flex flex-col justify-center items-center gap-16 shadow-[0_20px_50px_rgba(10,_57,_129,_0.7)]
">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex text-center p-2 items-center justify-between gap-5">
                        ...
                        <Link to="/PhotoShootPage">
                            <div className="w-[30vw] text-center flex flex-col justify-center p-4 gap-2 hover:shadow-[18px_18px_15px_-7px_#9ABF80] hover:border-[#9ABF80] hover:border-2 hover:transition duration-300 ease-in-out
">
                    ...
                    <div className="flex text-center p-2 items-center justify-between gap-5">
                        ...
                        <Link to='/WebDevPage'>
                            <div className="w-[30vw] text-center flex flex-col justify-center px-4 h-[19vh] gap-2 mb-5 hover:shadow-[18px_18px_15px_-7px_#9ABF80] hover:border-[#9ABF80] hover:border-2 hover:transition duration-300 ease-in-out">
